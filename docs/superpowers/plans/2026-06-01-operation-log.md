...
- Create: `modules/hephaestus-login/src/main/java/olympus/hephaestus/login/log/domain/OperationLogEntity.java`
  - 操作日志数据库实体。
- Create: `modules/hephaestus-login/src/main/java/olympus/hephaestus/login/log/dto/OperationLogResponse.java`
  - 操作日志列表响应 DTO。
- Create: `modules/hephaestus-login/src/main/java/olympus/hephaestus/login/log/dto/OperationLogRecordRequest.java`
  - 业务记录操作日志的请求 DTO。
- Create: `modules/hephaestus-login/src/main/java/olympus/hephaestus/login/log/repository/OperationLogRepository.java`
  - 操作日志 MyBatis Mapper，负责插入、分页查询和 count。
- Create: `modules/hephaestus-login/src/main/java/olympus/hephaestus/login/log/service/OperationLogService.java`
  - 操作日志服务接口。
- Create: `modules/hephaestus-login/src/main/java/olympus/hephaestus/login/log/service/impl/OperationLogServiceImpl.java`
  - 操作日志服务实现，负责旁路写入和分页查询。
- Create: `modules/hephaestus-login/src/main/java/olympus/hephaestus/login/log/controller/OperationLogController.java`
...
- Modify: `modules/hephaestus-login/src/main/java/olympus/hephaestus/login/config/controller/SystemConfigController.java`
  - 保存配置成功后记录操作日志。
- Modify: `modules/hephaestus-org/src/main/java/olympus/hephaestus/org/controller/OrgUnitController.java`
...
- Modify: `modules/hephaestus-org/src/main/java/olympus/hephaestus/org/role/service/impl/OrgRoleServiceImpl.java`
  - 岗位新增、修改、删除、岗位权限、刷新权限写操作接入操作日志。
- Modify: `modules/hephaestus-org/src/main/java/olympus/hephaestus/org/role/service/impl/OrgPersonRoleServiceImpl.java`
  - 岗位人员保存接入操作日志。
...
import olympus.hephaestus.mybatis.annotation.Column;
import olympus.hephaestus.mybatis.annotation.Id;
import olympus.hephaestus.mybatis.annotation.Table;
...
import olympus.hephaestus.login.log.domain.OperationLogEntity;
...
```java
package olympus.hephaestus.login.log.repository;
...
import olympus.hephaestus.login.log.dto.OperationLogRecordRequest;
import olympus.hephaestus.login.log.dto.OperationLogResponse;
import olympus.hephaestus.mybatis.pagination.Pagination;
...
import olympus.hephaestus.login.log.dto.OperationLogRecordRequest;
import olympus.hephaestus.login.log.dto.OperationLogResponse;
import olympus.hephaestus.login.log.repository.OperationLogRepository;
